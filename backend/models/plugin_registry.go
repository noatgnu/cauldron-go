...
type PluginRegistry struct {
	...
	// LastAppliedSchemaVersion is the plugin.yaml schemaVersion this install's CustomEnvVar entries were last reconciled against.
	LastAppliedSchemaVersion int            `gorm:"default:0" json:"lastAppliedSchemaVersion"`
